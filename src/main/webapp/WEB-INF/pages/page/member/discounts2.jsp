    ...
    <div class="layui-row">
    	<div class="layui-col-lg10 layui-col-md12 layui-col-sm12 layui-col-xs12">
    		<fieldset class="layui-elem-field layui-field-title site-title">
                <legend><a name="color-design">商品整额折扣管理</a></legend>
            </fieldset>
             <form class="layui-form " action="">
             	<div class="layui-form-item layui-input-inline">
             		<a class="layui-btn"  href="discounts1_info.html?discountType=${sessionScope.DiscountType.discountType}"><i class="layui-icon">&#xe61f;</i><cite>新建整额折扣</cite></a>
             	</div>
             	<div class="layui-form-item layui-input-inline">
...
<script type="text/javascript" src="js/discount2.js"></script> 
</body>
</html>