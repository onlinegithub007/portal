    ...
    <div class="layui-row">
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
    		<fieldset class="layui-elem-field layui-field-title site-title">
                <legend><a name="color-design">会员卡券信息管理</a></legend>
            </fieldset>
             <form class="layui-form " action="">
             	<div class="layui-form-item layui-input-inline">
             		<a class="layui-btn"  href="card_coupon_info.html"><i class="layui-icon">&#xe61f;</i><cite>批量新建卡券</cite></a>
             	</div>
             	<div class="layui-form-item layui-input-inline">
					<select name="interest" id="groupId">
				...
				<div class="layui-form-item layui-input-inline">
					<input type="text" id="createDateText" name="createDateText" autocomplete="off"  class="layui-input" placeholder="请选择颁发日期">
				</div>
             	<div class="layui-form-item layui-input-inline">
    	...
    	<div class="layui-col-lg10 layui-col-md12 layui-col-sm12 layui-col-xs12">
    		<div class="user-tables">
    			<table id="cardCouponsTables" lay-filter="cardCouponsTables"></table>
    		</div>
    	</div>
    </div>
</div>
