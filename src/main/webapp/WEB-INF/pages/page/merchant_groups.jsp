    ...
    <div class="layui-row">
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
    		<fieldset class="layui-elem-field layui-field-title site-title">
                <legend><a name="color-design">部门管理</a></legend>
            </fieldset>
            <div class="layui-btn-group larry-group" id="larry_group">
                <a class="layui-btn"  href="merchant_groups_info.html"><i class="layui-icon">&#xe61f;</i><cite>增加部门</cite></a>
            </div>
    	</div>
...
<script type="text/html" id="groupsbar">
  ...
  <a class="layui-btn layui-btn-normal layui-btn-mini" lay-event="user">用户</a>
</script>
<!-- 加载js文件 -->
