    ...
    <div class="layui-row">
    	<div class="layui-col-lg12 layui-col-md10 layui-col-sm12 layui-col-xs12">
    		<fieldset class="layui-elem-field layui-field-title site-title">
                <legend><a name="color-design">${sessionScope.ClientLevelTypeName}</a></legend>
            </fieldset>
            <div class="layui-btn-group larry-group" id="larry_group">
                <a class="layui-btn"  href="client_level_info.html"><i class="layui-icon">&#xe61f;</i><cite>${sessionScope.AddClientLevelTypeName}</cite></a>
            </div>
    	</div>
