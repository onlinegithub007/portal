    				...
    				<form class="layui-form" action="" method="post">
				        <div class="layui-form-item">
					        ...
					        <div class="layui-input-block">  
						        <input type="hidden" name="userId" value="${sessionScope.CurrMerUser.merUserId}">
						          <input type="text" name="userAccount" required lay-verify="account" autocomplete="off"  class="layui-input" value="${sessionScope.CurrMerUser.userAccount}" placeholder="输入用户账号">
					        </div>
				        </div>
				        <div class="layui-form-item">
				        	...
				        	<div class="layui-input-block">
				        		<select name="merGroupId" id="groupId">
									...
									<c:forEach var="group" items="${MerchantsGroups}">
										<option value="${group.merGroupId}">${group.groupName}</option>
									</c:forEach>
								</select>
				        	</div>
				        </div>
