    ...
    <div class="layui-row">
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
    		<fieldset class="layui-elem-field layui-field-title site-title">
                <legend><a name="color-design">门店库存调拨 终审</a></legend>
            </fieldset>
            
            <form class="layui-form " action="">
            	<div class="layui-form-item layui-input-inline">
            		<select name="orderStatus">
						<option value="0">选择调拨状态[已初审]</option>
						<option value="1">已终审</option>
						<option value="2">调出门店已确认</option>
						<option value="3">调入门店已签收</option>
...
<script type="text/javascript" src="js/stocks/master_stock_dispatch1.js"></script> 
</body>
</html>