    ...
    <div class="layui-row">
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
           	<fieldset class="layui-elem-field">
                <legend>
	                <a class="layui-btn layui-btn-small" href="store_stock_orders_audit.html?stockOrderStatus=3"><i class="layui-icon">&#xe65c;</i><cite>返回</cite></a>
	           		<a name="color-design">门店进货单处理</a>
	           	</legend>
    	...
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
   		  ...
   		  <c:if test="${sessionScope.CurrentStockOrder.providerCount > 0}">
	   		  <fieldset class="layui-elem-field layui-field-title site-title">
				  <legend><a name="color-design">供应商采购订单</a></legend>
			  </fieldset>
			  <div class="user-tables">
	   			<table id="providerPurchaseTables" lay-filter="providerPurchaseTables"></table>
	   		  </div>
		  </c:if>
		  
		  <c:if test="${sessionScope.CurrentStockOrder.storeCount > 0}">
			  <fieldset class="layui-elem-field layui-field-title site-title">
				  <legend><a name="color-design">门店调拨订单</a></legend>
			  </fieldset>
		  	  <div class="user-tables">
	   			<table id="storePurchaseTables" lay-filter="storePurchaseTables"></table>
	   		  </div>
		  </c:if>
   		  ...
   		  <blockquote class="layui-elem-quote" style="text-align:right">
           		...
           		<a class="layui-btn layui-btn-normal" id="stockOrderSaveBtn" href="#"><i class="larry-icon">&#xe88f;</i> <cite>确定下达采购单 / 门店调拨单</cite></a>
            </blockquote>
    	</div>
    </div>
</div>
...
<script type="text/html" id="viewStoreGoodsTpl">
  <a class="layui-btn layui-btn-mini" lay-event="viewOrder">调拨单预览</a>
</script>
...
<script type="text/javascript" src="js/stocks/store_stock_orders_audit3.js"></script> 
</body>
</html>