    ...
    <div class="layui-row">
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
           	<fieldset class="layui-elem-field layui-field-title site-title">
                <legend>
	           		<a name="color-design">库存调拨单预览</a>
	           	</legend>
	        </fieldset>
	        <blockquote class="layui-elem-quote">
	        	<i class="larry-icon" style="font-size:16pt;color:#009688">&#xe740;</i> 
	        	调拨单编号：${sessionScope.CurrentPurchaseOrders.orderSn}，门店进货单编号：${sessionScope.CurrentPurchaseOrders.stockOrderId}
	        </blockquote>
            <blockquote class="layui-elem-quote">
	            <i class="larry-icon" style="font-size:16pt;color:#009688">&#xe740;</i> 
            ...
            <blockquote class="layui-elem-quote">
	            <i class="larry-icon" style="font-size:16pt;color:#009688">&#xe740;</i> 
	            调拨门店：${sessionScope.CurrentPurchaseOrders.providerName}, ${sessionScope.ProviderStore.detailAddress}<br>
