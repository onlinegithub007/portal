    ...
    <div class="layui-row">
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
    		<fieldset class="layui-elem-field layui-field-title site-title">
                <legend><a name="color-design">供应商订单</a></legend>
            </fieldset>
            <form class="layui-form " action="">
            	<div class="layui-form-item layui-input-inline">
            		<select name="providerAckStatus">
            			<option value="">全部</option>
						<option value="0">新订单</option>
						<option value="1">已确认未修改</option>
						<option value="2">已确认且修改</option>
					</select>
            	</div>
            	<div class="layui-form-item layui-input-inline">
...
<a class="layui-btn layui-btn-mini" lay-event="ack">确认</a>
{{#  }else { }}
...
<script type="text/html" id="providerAckAuditTpl">
