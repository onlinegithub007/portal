    ...
    <div class="layui-row">
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
    		<fieldset class="layui-elem-field layui-field-title site-title">
                <legend>
                <c:if test="${sessionScope.CurrentPurchaseOrders.orderStatus == 0 || sessionScope.CurrentPurchaseOrders.orderStatus == 3}">
                <a class="layui-btn layui-btn-small" href="master_stock_dispatch1.html"><i class="layui-icon">&#xe65c;</i><cite>返回</cite></a>
                </c:if>
                ...
                <c:if test="${sessionScope.CurrentPurchaseOrders.orderStatus == 2}">
                <a class="layui-btn layui-btn-small" href="master_stock_dispatch4.html"><i class="layui-icon">&#xe65c;</i><cite>返回</cite></a>
                </c:if>
    	...
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
    		...
    		<div style="text-align:right">
				...
				<c:if test="${sessionScope.CurrentPurchaseOrders.orderStatus == 0}">
		       		<a class="layui-btn" id="executeDispachBtn" href="#"><i class="larry-icon">&#xe88f;</i> <cite>已经通知供应商，执行调拨</cite></a>
				</c:if>
				<c:if test="${sessionScope.CurrentPurchaseOrders.orderStatus == 1}">
		       		<a class="layui-btn" id="ackOutDispachBtn" href="#"><i class="larry-icon">&#xe88f;</i> <cite>我已核对出库商品数量，确认出库</cite></a>
				</c:if>
				<c:if test="${sessionScope.CurrentPurchaseOrders.orderStatus == 2}">
		       		<a class="layui-btn" id="acceptDispachBtn" href="#"><i class="larry-icon">&#xe88f;</i> <cite>我已核对入库商品数量，确认入库</cite></a>
				</c:if>
	        </div>
    	</div>
