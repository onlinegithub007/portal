    ...
    <div class="layui-row">
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
    		<fieldset class="layui-elem-field layui-field-title site-title">
                <legend><a name="color-design">门店库存调拨出库确认单</a></legend>
            </fieldset>
            <blockquote class="layui-elem-quote">
	            <i class="larry-icon" style="font-size:16pt;color:#009688">&#xe740;</i> 
	            下面是别的分店的库存调拨申请单，已经经由了总部的审批，请进一步操作完成库存出库确认，然后将货发到申请门店。
	        </blockquote>
    	</div>

    	<div class="layui-col-lg10 layui-col-md12 layui-col-sm12 layui-col-xs12">
    		<div class="user-tables">
    			<table id="goodsStockOutTables" lay-filter="goodsStockOutTables"></table>
    		</div>
    	</div>
    </div>
</div>
...
<script type="text/html" id="viewTpl">
   <a class="layui-btn layui-btn-mini" lay-event="view">查看调拨商品</a>
</script>
