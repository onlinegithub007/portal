    ...
    <div class="layui-row">
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
           	<fieldset class="layui-elem-field">
                <legend>
	                <a class="layui-btn layui-btn-small" href="store_stock_orders_audit.html?stockOrderStatus=2"><i class="layui-icon">&#xe65c;</i><cite>返回</cite></a>
	           		<a name="color-design">门店进货单主管确认</a>
	           	</legend>
    	...
    	<div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
   		  ...
   		  <blockquote class="layui-elem-quote" style="text-align:right">
           		...
           		<a class="layui-btn layui-btn-normal" id="stockOrderSaveBtn" href="#"><i class="larry-icon">&#xe88f;</i> <cite>对初审无异议，下一步进入采购/调度</cite></a>
            </blockquote>
    	</div>
    </div>
</div>
...
<script type="text/javascript" src="js/stocks/store_stock_orders_audit2.js"></script> 
</body>
</html>