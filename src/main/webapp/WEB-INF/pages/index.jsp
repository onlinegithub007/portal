...
<head>
	<meta charset="UTF-8">
	<title>${sessionScope.SystemTitle}</title>
...
<div class="layui-layout layui-layout-admin larrycms-admin" id="larry_admin_out">
    ...
    <div class="layui-side pos-a larrycms-left layui-bg-black" id="larry_left">
        <div class="layui-side-scroll">
            ...
            <div class="user-info">
                ...
                <p>${sessionScope.CurrentMerUser.merName} 您好！欢迎登录</p>
            </div>
             -->
            <!-- 系统菜单 -->
    ...
    <div class="layui-footer pos-a larrycms-footer" id="larry_footer">
    	<div class="layui-main">
               <p class="inline-block">${sessionScope.SystemCopyright}<a href="#" target="_blank" class="fp"> </a> </p> 
         </div>
    </div>
</div>
<!-- 加载js文件-->
