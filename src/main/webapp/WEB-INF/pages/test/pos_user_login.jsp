...
<form class="layui-form" method="post" action="${ctx}/posUserLogin">
	...
	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="userAccount" required  autocomplete="off" value="18627151402" class="layui-input">
	    </div>
	</div>
	...
	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="password" name="userPassword"  autocomplete="off" value="25D55AD283AA400AF464C76D713C07AD" class="layui-input">
	    </div>
	</div>
