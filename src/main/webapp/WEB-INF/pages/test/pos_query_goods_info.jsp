...
<title>Pos Query Goods info</title>
...
<fieldset class="layui-elem-field layui-field-title">
  <legend>查询商品信息</legend>
</fieldset>
<form class="layui-form" method="post" action="${ctx}/posQueryGoodsByCode">
	...
	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="goodsCode"  autocomplete="off" value="" class="layui-input">
	    </div>
	</div>
